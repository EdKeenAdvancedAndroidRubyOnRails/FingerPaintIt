...
public class DrawingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // drawable image on the button to show that it is currently selected:
    ...
    public void onClick(View view){
        ...
        if(view.getId() == R.id.draw_btn){
            ...
            //new button
            // new drawing confirmation dialog
                ...
                public void onClick(DialogInterface dialog, int which){
                    ...
                    if(imgSaved!=null){
                        ...
                        Toast unsavedToast = Toast.makeText(getApplicationContext(),
                                "Stupid Technology! Image could not be saved.", Toast.LENGTH_SHORT);
                        unsavedToast.show();
                    }
                }
            });
